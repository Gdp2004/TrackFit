...
import { Coach, CoachWithUser, Prenotazione, CoachStats, PrenotazioneWithUser } from "@/backend/domain/model/types";
...
export interface CoachRepositoryPort {
    ...
    findPrenotazioniByCoachId(coachid: string): Promise<PrenotazioneWithUser[]>;
