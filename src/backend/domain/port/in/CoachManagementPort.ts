...
export interface CoachManagementPort {
    ...
    annullaSessione(coachid: string, sessioneid: string, motivazione: string): Promise<void>; // OCL R1
    ...
    getPrenotazioniCoach(coachid: string): Promise<PrenotazioneWithUser[]>;
